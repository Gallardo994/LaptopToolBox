namespace LaptopToolBox.DeviceControls.PowerLimits.Vendors.Asus.Models;

public class PowerLimitInfo_G513RW : IPowerLimitRangeInfo
{
    public IPowerRange CpuSpl { get; } = new PowerRange { Default = 45, Min = 30, Max = 90 };
    public IPowerRange CpuSppt { get; } = new PowerRange { Default = 45, Min = 30, Max = 100 };
    public IPowerRange CpuFppt { get; } = new PowerRange { Default = 45, Min = 30, Max = 125 };
