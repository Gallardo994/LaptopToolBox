...
using LaptopToolBox.AppUpdater.Commands;
using LaptopToolBox.AppUpdater.Downloaders;
...
public partial class AppUpdateProvider : ObservableObject, IAppUpdateProvider
{
    ...
    public void InstallUpdate()
    {
        ...
        var processStartInfo = new ProcessStartInfo
        {
            ...
            Arguments =
                $"--zipPath=\"{InstallableUpdate.DownloadedFilePath}\" --targetDir=\"{AppDomain.CurrentDomain.BaseDirectory.TrimEnd('\\')}\" --runAfter=\"LaptopToolBox.exe\"",
