...
namespace GHelper.DeviceControls.CPU.Vendors.AMD
{
    public class Ols : IOls
    {
        ...
        public _GetDllStatus GetDllStatus { get; init; } = null;
        public _GetDriverType GetDriverType { get; init; } = null;
        public _GetDllVersion GetDllVersion { get; init; } = null;
        public _GetDriverVersion GetDriverVersion { get; init; } = null;

        public _InitializeOls InitializeOls { get; init; } = null;
        public _DeinitializeOls DeinitializeOls { get; init; } = null;
        ...
        public _Cpuid Cpuid { get; init; } = null;
        ...
        public _ReadPciConfigDword ReadPciConfigDword { get; init; }
        ...
        public _ReadPciConfigDwordEx ReadPciConfigDwordEx { get; init; }


        public delegate int _ReadPciConfigDwordEx64(uint pciAddress, uint regAddress, ref ulong value);
        public _ReadPciConfigDwordEx64 ReadPciConfigDwordEx64 { get; init; }
        ...
        public _WritePciConfigDword WritePciConfigDword { get; init; }
        ...
        public _WritePciConfigDwordEx WritePciConfigDwordEx { get; init; }

        public delegate int _WritePciConfigDwordEx64(uint pciAddress, uint regAddress, ulong value);
        public _WritePciConfigDwordEx64 WritePciConfigDwordEx64 { get; init; }
